@if ( $challenges->count() > 0 )
    ...
    <div class="panel panel-default shade top-bottom-border">
        ...
        <h4 style="color: #06774a;margin: 5px 0pxfont-size: 13px;">
            {{ trans('player.searchMyChallenges') }}
            <span id="myChallengesloader" style="display:none;">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        <label style="color:#06774a;font-size:12px" for="winner" >
                            {{ trans('player.Challenge_Creator') }} :
                        </label>
                        
                        <label class="radio-inline" style="font-size: 15px;">
                            <input type="radio" 
                            name="myChallenges_filter_creator" 
                            value="1" 
                        >
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <label class="radio-inline" style="font-size: 15px;">
                            <input type="radio" 
                            name="myChallenges_filter_winner" 
                            value="1" 
                            >
                            <span style="font-size: 80%;font-weight: bold;color: #06774a;">
                                {{ trans('player.me') }}
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" 
                                ...
                                name="myChallenges_filter_candidate" 
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <select name="myChallenges_filter_from" id="newEventFromInput" style="padding: 0 5px 0 10px;height:20px;font-size: 12px;" class="myEventsSearch sm-inputs form-control">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <select name="myChallenges_filter_to" id="newEventToInput" style="padding: 0 5px 0 10px;height:20px;font-size: 12px;" class="myEventsSearch sm-inputs form-control">
