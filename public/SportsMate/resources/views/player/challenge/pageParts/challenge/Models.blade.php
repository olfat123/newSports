  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
          ...
          <div id="" class="modal-body">
            ...
            {{ csrf_field() }}
            <input type="hidden" name="EventType" value="challenge">
            <input type="hidden" name="MainEvent" value="{{$challenge->id}}">
            ...
            <div class="row">
                <div class="col-xs-6 text-center">
                    ...
                    <div style="margin-top: 25px;">
                        ...
                        <input type="number" class="sm-inputs" name="CreatorScore" value="0" style="width: 25%;border: 0px;padding:0 5px 0 5px">
                    </div>
                </div>
                ...
                <div class="col-xs-6 text-center">
                    <div style="border-radius: 100%; overflow: hidden; width: 60px; height: 60px; margin-top: 15px;margin: 0px auto;">
                        <img style="width: 60px;" 
                            @if ($challenge->C_candidate_id == null)
                        ...
                        >
                            ...
                            <div class="text-center" style="margin-top: 25px;">
                                ...
                                <input type="number" class="sm-inputs" name="CandidateScore" value="0" style="width: 25%;border: 0px;padding:0 5px 0 5px">
                            </div>
                    </div>
...
<div id="RatePlayerModal" class="modal" role="dialog">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
          ...
          <div class="row text-center">
            <div class="col-md-6">
             <p class="question shade-2"> Comment </>
            </div>
            <div class="col-md-6">
