...
<section class="players-main">
  <div class="container">
      ...
      <div class="col-md-4" >
        ...
        >
          ...
          <div id="display-MainInfo">
            @include('player.club.pageParts.club.display-MainInfo')
          </div>
      ...
      <div class="col-md-8">
        ...
        <div class="separator" style="height: auto;margin:3px ">
          <div id="display-selectedInfo">
            @include('player.club.pageParts.club.slider')
          </div>
        </div>
        <div class="row">
          <div class="separator" style="height: auto;margin:3px ">
            ...
            <div id="branches">
              ...
              @include('player.club.pageParts.club.branches')
    ...
    {{--------------------------------------------------------------------}}
        @include('player.club.pageParts.club.Models')
    {{------------------------------------------------------------------------}}
