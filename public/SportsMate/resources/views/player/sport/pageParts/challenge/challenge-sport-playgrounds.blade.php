...
<div>
	<div class="panel panel-default shade top-bottom-border">
      ...
      <!--------------------->
        ...
        <h4 style="color: #06774a;margin: 5px 0px">{{$challenge->challengeSport->en_sport_name}} Playgrounds</h4>
        </div>
{{------------------------------------------------------------}}
<!--------------->
    ...
    @if ($challenge->expectedPlaygrounds->contains($playground->id) == false) <!--if for know if play Playground in suggested-->
        ...
        @else
        	<div class="col-md-4">
              ...
              >
                <a href="{{url('/')}}/profile/{{sm_crypt($playground->id)}}" class="a-holding-divs" >
