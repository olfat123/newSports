         ...
         <tr>
            <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
                ...
                <div style="line-height: 35px">
                    ...
                    Dear <span style="color: #5caad2;">taha mostafa</span>
                    <p style="font-size: 250%;color: #66BB6A;">
                                ...
                                <tr>
                                    <td align="center" style="color: #5caad4; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px">
                                            you have recieved this email baecouse your account accepted to be one of our clubs, thanks to join us our vision . 
                                        </div>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td align="center" style="color: #607d8b; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px">
                                            ...
                                            you are welcome to login and enjoy SportsMate.
                                        </div>
                                    </td>
                                </tr>
                            </table>
