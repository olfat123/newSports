...
class ClubsDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('checkbox', 'admin.Clubs.btns.checkbox')
            ->addColumn('edit', 'admin.Clubs.btns.edit')
            ->addColumn('delete', 'admin.Clubs.btns.delete')
            ->rawColumns([
                'checkbox',
                'edit',
                'delete'
    ...
    {
        return $model->newQuery()->select('id', 'name', 'slug', 'email', 'created_at', 'updated_at')->where('type', 2);
    }
