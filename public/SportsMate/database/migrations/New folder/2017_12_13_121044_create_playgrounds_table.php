...
class CreatePlaygroundsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('playgrounds', function (Blueprint $table) {
            ...
            $table->boolean('feature 1')->default(0);
            $table->boolean('feature 2')->default(0);
            $table->boolean('feature 3')->default(0);
            $table->boolean('feature 4')->default(0);
            $table->boolean('feature 5')->default(0);
            $table->boolean('feature 6')->default(0);
            $table->boolean('feature 7')->default(0);
            $table->boolean('feature 8')->default(0);
            $table->boolean('feature 9')->default(0);
            $table->boolean('feature 10')->default(0);
            $table->timestamps();
        });
    }
