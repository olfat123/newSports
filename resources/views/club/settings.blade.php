...
<div class="box">
  ...
  <div class="box-body">
    ...
    <div class="form-group">
      {!! Form::label('email',trans('admin.siteMainEmail')) !!}
    ...
    <div class="form-group">
      ...
      @if(!empty(setting()->logo))
        <img class="img img-responsive" src="{{ Storage::url(setting()->logo) }}" style="width: 50px;height: 50px;" >
      @endif
    </div>
    <div class="form-group">
      ...
      {!! Form::file('icon',['class'=>'form-control']) !!}
       ...
       @if(!empty(setting()->icon))
        <img class="img img-responsive" src="{{ Storage::url(setting()->icon) }}" style="width: 50px;height: 50px;" >
      @endif
    </div>
    <div class="form-group">
    ...
    {!! Form::submit(trans('admin.saveSettingBtn'),['class'=>'btn btn-primary']) !!}
    {!! Form::close() !!}
  </div>
  <!-- /.box-body -->
</div>
