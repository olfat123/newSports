...
<head>
    ...
    <title>Rejected Club Account</title>
         ...
         <tr>
            <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
                ...
                <div style="line-height: 35px">
                    ...
                    Dear <span style="color: #5caad2;">{{ $name }}<!-- taha mostafa --></span>
                    <p style="font-size: 250%;color: #f00;">
                    ...
                    <tr>
                        <td align="center">
                            <table border="0" width="400" align="center" cellpadding="0" cellspacing="0" class="container590">
                                <tr>
                                    <td align="center" style="color: #f00; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px">
                                            you have recieved this email baecouse your account contain un acceptable infolrmation, details below . 
                                        </div>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td align="center" style="color: #607d8b; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px">
                                            ...
                                            you are welcome to login again and edit the acceptable infolrmation .
                                        </div>
                                    </td>
                                </tr>
                            </table>
