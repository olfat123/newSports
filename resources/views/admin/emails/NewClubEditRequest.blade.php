...
<head>
    ...
    <title>Club Fixed Account Data Errors</title>
...
<body class="respond" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
         ...
         <tr>
            <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
                ...
                <div style="line-height: 35px">
                    ...
                    <p style="font-size: 200%;color: #66BB6A;">
        ...
        <tr>
            <td align="center">
                <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                    ...
                    <tr>
                    <table border="1" align="center" width="590" cellpadding="0" cellspacing="0" class="container590" style="margin: 25px">
                        <thead style="text-align: center;
                                    background: #ddd;
                                    color: #5caad2;"        
                        > 
                            <th height="20" 
                                style="font-size: 25px; line-height: 35px;font-family:sans-serif"
                        ...
                        <tbody>
                            @php
                                $old_data = json_decode( $pendingEdit->old_data, TRUE ) ;
                                $new_data = json_decode( $pendingEdit->new_data, TRUE ) ;
                                $models = ['city'   => ['modelPath' => '\App\Model\Governorate',
                                                         'name' => 'g_en_name'], 
                                            'area'  => ['modelPath' => '\App\Model\Area', 
                                                        'name' => 'a_en_name'], 
                                            'sport' => ['modelPath' => '\App\Model\Sport', 
                                                        'name' => 'en_sport_name']
                                        ] ;
                            @endphp
                            @foreach ($old_data as $key => $value)
                                <tr style="text-align:center;color: #9e9e9e;font-family: sans-serif;">
                                    <td height="20" style="padding:10px;font-size: 20px; line-height: 30px;">
                                        @php
                                            if (is_int($value) !== false) {
                                                echo "is int  ";
                                               foreach ($models as $mkey => $mvalue) {
                                                    if (strpos($key, $mkey) !== false) {
                                                        $modelname = $mvalue['modelPath'] ;
                                                        $keyold[$mkey] = $modelname::find($value) ;

                                                        print_r($keyold[$mkey]) ;
                                                        //echo $keyold[$mkey]->$mvalue['name'] ;
                                                        $keynew[$mkey] = $modelname::find($new_data[$key]) ;
                                                        //echo $keynew[$mkey]->$mvalue['name']  ;
                                                    } 
                                                }
                                            } else {
                                    ...
                                    <td height="20" style="padding:10px;font-size: 20px; line-height: 30px;">   @php
                                            /*if ($keynew) {
                                                echo $keynew ;
                                            } else {
                                               echo $new_data[$key] ;
    ...
    <table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="ffffff" class="bg_color">
        ...
        <tr>
            <td align="center" style="background: #f4f4f4;padding-top: 10px;padding-bottom: 10px">
                                ...
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;" class="text_color">
                                        <div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
                                            ...
                                            Email us: <br/> <a href="mailto:" style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">info@mindholding.net</a>
                                ...
                                <tr>
                                    <td>
                                        <table border="0" align="right" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <a href="https://www.facebook.com/SportsmateEgypt/?ref=br_tf" style="display: block; border-style: none !important; border: 0 !important;"><img width="24" border="0" style="display: block;" src="http://i.imgur.com/RBRORq1.png" alt=""></a>
                                                </td>
                                                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                <!-- <td>
                                                    <a href="https://twitter.com/MDBootstrap" style="display: block; border-style: none !important; border: 0 !important;"><img width="24" border="0" style="display: block;" src="http://i.imgur.com/Qc3zTxn.png" alt=""></a>
                                                </td> -->
                                                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                <!-- <td>
