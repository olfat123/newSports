                                ...
                                <tr>
                                    <td align="center" style="color: #5caad4; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px">
                                            you have recieved this email baecouse you are Admin at SportsMate, So you will be notified about every club fixed account data errors . 
                                        </div>
                                    </td>
                                </tr>
                            </table>
                                        ...
                                        <tr>
                                            <td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;">
                                                ...
                                                <div style="line-height: 26px;">
                                                    <a 
                                                        href="{{url('mailRedirect')}}?url=admin/clubs/{{ $club->id }}&kind=admin" 
