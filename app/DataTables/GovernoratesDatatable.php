...
class GovernoratesDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('checkbox', 'admin.Governorates.btns.checkbox')
            ->addColumn('edit', 'admin.Governorates.btns.edit')
            ->addColumn('delete', 'admin.Governorates.btns.delete')
            ->rawColumns([
                'checkbox',
                'edit',
                'delete',
    ...
    public function query(Governorate $model)
    {
        return DB::table('governorates')
            ->leftJoin('countries AS Country', 'governorates.g_country_id', '=', 'Country.id')
            //->leftJoin('users AS Candidate', 'events.E_candidate_id', '=', 'Candidate.id')

            
            ->select(['governorates.*',  
                        'Country.c_ar_name as ar_Country',
                        'Country.c_en_name as en_Country',
    ...
    /*public function query(Governorate $model)
    {
        return $model->newQuery()->select('id', 'g_en_name', 'g_ar_name', 'g_country_id');
    }*/
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                'name'      => (direction() == 'rtl') ? 'ar_Country' : 'en_Country' ,
                'data'      => (direction() == 'rtl') ? 'ar_Country' : 'en_Country' ,
                'title'     => trans('admin.CountryName'),
            ],
            [
                'name'          => 'edit',
                'data'          => 'edit',
